...
(function() {
  ...
  Graph = (function() {
    ...
    function Graph(canvas) {
      ...
      if (this.r) {
        ...
        canvas.style[Dynamics.BrowserSupport.prefixFor('transform') + 'Transform'] = 'scale(' + (1 / this.r) + ')';
      }
    }
  ...
  App = (function() {
    ...
    App.prototype.dynamicsClasses = [Dynamics.Spring, Dynamics.Spring2];
    ...
    App.prototype.updateOptions = function() {
      var config, property, slider, tweenOptionsEl, values, _i, _len, _ref, _ref1, _results;
