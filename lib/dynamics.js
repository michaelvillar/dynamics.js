...
(function() {
  var Animation, Animations, Bezier, BrowserSupport, Dynamic, Dynamics, EaseInOut, Gravity, GravityWithForce, Linear, MatrixTools, SelfSpring, Spring, VectorTools, css, stopAnimationsForEl,
  ...
  Animation = (function() {
    ...
    Animation.prototype.convertTransformToMatrix = function(transform, callback) {
    ...
    Animation.prototype.apply = function(t, args) {
      var dValue, frame0, frame1, k, matrix, newValue, oldValue, progress, properties, transform, unit, v, value, _results;
      if (args == null) {
        args = {};
      }
