...
(function() {
  var Bezier, BrowserSupport, Dynamic, Dynamics, Gravity, GravityWithForce, Linear, SelfSpring, Spring, Tween, TweenBezier, TweenForce, TweenGravity, TweenLinear, TweenSelfSpring, TweenSpring,
  ...
  TweenSelfSpring = (function(_super) {

    __extends(TweenSelfSpring, _super);

    function TweenSelfSpring() {
      this.next = __bind(this.next, this);
      return TweenSelfSpring.__super__.constructor.apply(this, arguments);
    }

    TweenSelfSpring.properties = {
      frequency: {
        min: 0,
        max: 100,
        "default": 15
    ...
    TweenSelfSpring.prototype.next = function(step) {
      var A, At, At2, Ax, angle, frequency, friction, t, v,
        _this = this;
      TweenSelfSpring.__super__.next.call(this, step);
      t = this.currentT;
      frequency = Math.max(1, this.options.frequency);
      friction = Math.pow(20, this.options.friction / 100);
      A = function(t) {
    ...
    return TweenSelfSpring;

  })(Tween);

  TweenBezier = (function(_super) {

    __extends(TweenBezier, _super);

    function TweenBezier() {
      this.next = __bind(this.next, this);
      ...
      return TweenBezier.__super__.constructor.apply(this, arguments);
    }

    TweenBezier.properties = {
      points: {
        type: 'points',
        "default": [
          {
    ...
    TweenBezier.prototype.B_ = function(t, p0, p1, p2, p3) {
      return (Math.pow(1 - t, 3) * p0) + (3 * Math.pow(1 - t, 2) * t * p1) + (3 * (1 - t) * Math.pow(t, 2) * p2) + Math.pow(t, 3) * p3;
    };

    TweenBezier.prototype.B = function(t, p0, p1, p2, p3) {
      return {
  ...
  Spring = (function(_super) {
    ...
    function Spring(el, from, to, options) {
      ...
      this.to = to;
      this.options = options != null ? options : {};
      Spring.__super__.constructor.call(this, this.el, {
        0: this.from,
        100: this.to
      }, this.options);
    }
  ...
  SelfSpring = (function(_super) {
    ...
    SelfSpring.prototype.tweenClass = "TweenSelfSpring";

    SelfSpring.properties = TweenSelfSpring.properties;
    ...
    function SelfSpring(el, from, to, options) {
      ...
      this.to = to;
      this.options = options != null ? options : {};
      SelfSpring.__super__.constructor.call(this, this.el, {
        0: this.from,
        100: this.to
      }, this.options);
    }
  ...
  Gravity = (function(_super) {
    ...
    function Gravity(el, from, to, options) {
      ...
      Gravity.__super__.constructor.call(this, this.el, {
        0: this.from,
        100: this.to
      }, this.options);
    }
  ...
  GravityWithForce = (function(_super) {
    ...
    function GravityWithForce(el, from, to, options) {
      ...
      GravityWithForce.__super__.constructor.call(this, this.el, {
        0: this.from,
        100: this.to
      }, this.options);
    }
  ...
  Linear = (function(_super) {
    ...
    Linear.prototype.tweenClass = "TweenLinear";

    Linear.properties = TweenLinear.properties;

    function Linear(el, from, to, options) {
      this.el = el;
      this.from = from;
      this.to = to;
      this.options = options != null ? options : {};
      Linear.__super__.constructor.call(this, this.el, {
        0: this.from,
        100: this.to
      }, this.options);
    }
  ...
  Bezier = (function(_super) {
    ...
    Bezier.prototype.tweenClass = "TweenBezier";

    Bezier.properties = TweenBezier.properties;

    function Bezier(el, from, to, options) {
      this.el = el;
      this.from = from;
      this.to = to;
      this.options = options != null ? options : {};
      Bezier.__super__.constructor.call(this, this.el, {
        0: this.from,
        100: this.to
      }, this.options);
    }
